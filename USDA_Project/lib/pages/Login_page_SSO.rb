class Login_Page < GenericBasePage
  ...
  # read_workbook = RubyXL::Parser.parse("#{dir_to_excel}/UsdaTestData.xlsx")
  # worksheet = read_workbook['Login_info']
  # page_url worksheet[1][2].value


  # page_url "http://10.103.138.59:8080/infopass-admin/login"
  # page_url "https://sso.preprod.uscis.dhs.gov/sso/UI/Login"
  sleep 3
